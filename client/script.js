...
const handleSubmit = async (e) => {
  ...
  messageWrapper.innerHTML = chatStripe(true, ' ', uniqueId) + messageWrapper.innerHTML;
  ...
  // user's chatstripe
  messageWrapper.innerHTML = chatStripe(false, data.get('prompt')) + messageWrapper.innerHTML;
