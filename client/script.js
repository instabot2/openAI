...
function addBlur() {
  if ((textarea === document.activeElement && textarea.value.length > 0) || hiddenText.style.display === "block") {
...
function handleTextarea() {
  ...
  if (hiddenText === document.activeElement || hiddenText.style.display === "block") {
    addBlur();
  } else {
    removeBlur();
  }
